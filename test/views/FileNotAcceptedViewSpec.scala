...
class FileNotAcceptedViewSpec extends SpecBase with GuiceOneAppPerSuite with Injecting with ViewHelper {
  val view: FileNotAcceptedView                                         = app.injector.instanceOf[FileNotAcceptedView]
