  ...
  "CheckYourFileDetailsViewModel" - {
      ...
      "must return the getSummaryList for File Details when No Election Required for CRS" in {
        val expectedSummary = SummaryList(
          List(
            ...
            SummaryListRow(Key(Text("File information")), Value(Text("New information")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
    ...
    ".getFIDetailsRows" - {
      "must return the getSummaryList for FIDetails when report Election is false for CRS" in {
        ...
        val expectedSummary = SummaryList(
          List(
            SummaryListRow(Key(Text(s"Do you want to make any elections for the CRS reporting period $reportingPeriodYear?")), Value(Text("No")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
                    href = routes.IndexController.onPageLoad().url,
      ...
      "must return the getSummaryList for FIDetails when report Election is true and reporting period lesser than 2026 for CRS" in {
        ...
        val expectedSummary = SummaryList(
          List(
            SummaryListRow(Key(Text(s"Do you want to make any elections for the CRS reporting period $reportingPeriodYear?")), Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
                    href = routes.IndexController.onPageLoad().url,
            ...
            SummaryListRow(Key(Text("Are they excluding cash value insurance contracts or annuity contracts from their reporting for CRS?")),
              Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
            ...
            SummaryListRow(Key(Text("Are they treating dormant accounts as not being reportable accounts for CRS?")), Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
                    href = routes.IndexController.onPageLoad().url,
            ...
            SummaryListRow(Key(Text("Are they applying thresholds to any of their accounts in their due diligence process for CRS?")),
              Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
      ...
      "must return the getSummaryList for FIDetails when report Election is true and reporting period is 2026 And Carf Gross Proceed is false for CRS" in {
        ...
        val expectedSummary = SummaryList(
          List(
            ...
            SummaryListRow(Key(Text("Are they reporting gross proceeds under the Cryptoasset Reporting Framework (CARF) for 2026?")),
              Value(Text("No")), "", Some(
                Actions(
                  items = Seq(
                    ActionItem(
      ...
      "must return the getSummaryList for FIDetails when report Election is true and reporting period is 2026 And Carf Gross Proceed is true for CRS" in {
        ...
        val expectedSummary = SummaryList(
          List(
            ...
            SummaryListRow(Key(Text("Are they also reporting these gross proceeds for the CARF under CRS?")),
              Value(Text("Yes")), "", Some(
                Actions(
                  items = Seq(
                    ActionItem(
      ...
      "must return the getSummaryList for FIDetails when report Election is false for FATCA" in {
        ...
        val expectedSummary = SummaryList(
          List(
            SummaryListRow(Key(Text(s"Do you want to make any elections for the FATCA reporting period $reportingPeriodYear?")), Value(Text("No")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
                    href = routes.IndexController.onPageLoad().url,
      ...
      "must return the getSummaryList for FIDetails when report Election is true for FATCA and No GIIN required" in {
        ...
        val expectedSummary = SummaryList(
          List(
            SummaryListRow(Key(Text(s"Do you want to make any elections for the FATCA reporting period $reportingPeriodYear?")), Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
                    href = routes.IndexController.onPageLoad().url,
            ...
            SummaryListRow(Key(Text("Are they using due diligence procedures from US Treasury Regulations for FATCA?")),
              Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
            ...
            SummaryListRow(Key(Text("Are they applying thresholds to any of their accounts in their due diligence process for FATCA?")),
              Value(Text("Yes")), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
      ...
      "must return the getSummaryList for FIDetails when report Election is true for FATCA and GIIN required" in {
        ...
        val expectedSummary = SummaryList(
          List(
            SummaryListRow(Key(Text("Global Intermediary Identification Number")), Value(Text(testGIINValue)), "", Some(
              Actions(
                items = Seq(
                  ActionItem(
                    href = routes.IndexController.onPageLoad().url,
